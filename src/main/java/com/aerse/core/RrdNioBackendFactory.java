...
/**
 * Factory class which creates actual {@link com.aerse.core.RrdNioBackend} objects. This is the default factory since
 * 1.4.0 version.
 * <h3>Managing the thread pool</h3>
 * Each RrdNioBackendFactory is backed by a {@link com.aerse.core.RrdSyncThreadPool}, which it uses to sync the memory-mapped files to
...
public class RrdNioBackendFactory extends RrdFileBackendFactory {
     ...
     * com.aerse.core.RrdBackendFactory#getDefaultFactory()}, but not if clients provide their own backend instance when
