...
/**
 * Thread pool used by {@link com.aerse.core.RrdNioBackend} instances to periodically sync the mapped file to disk. Note that instances
...
public final class RrdSyncThreadPool
{
     ...
     * Defaults to {@value com.aerse.core.RrdNioBackendFactory#DEFAULT_SYNC_CORE_POOL_SIZE} threads.
     */
    private final ScheduledExecutorService syncExecutor;

    /**
     * Creates a new RrdSyncThreadPool with a default pool size of {@value com.aerse.core.RrdNioBackendFactory#DEFAULT_SYNC_CORE_POOL_SIZE}.
     */
